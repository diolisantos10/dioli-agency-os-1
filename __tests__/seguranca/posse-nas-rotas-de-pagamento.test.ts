...
// o conserto foi partido em dois PRs porque ESTE lado tem consequência de
// NEGÓCIO: um Pix de pedido órfão passa a ser recusado até o vínculo existir.
// O outro par (`posse-nas-rotas-de-parceria`) é risco baixo e não fica preso
// esperando esta decisão.
//
// O ARRANJO é o mesmo dos dois arquivos, de propósito: duplicá-lo UMA vez
// custa menos que quatro, e um arranjo por PR evita que um vermelho segure o
// outro.
