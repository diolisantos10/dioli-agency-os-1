...
// ── ESTE ARQUIVO É METADE DE UM PAR (07/09/2026) ───────────────────────────
//
// A varredura de 29/08 provou as CINCO rotas num arquivo só. Na hora de subir,
// o conserto foi partido em dois PRs para que o de `admin/pagamentos` — o
// único com consequência de negócio (um Pix de pedido órfão passa a ser
// recusado até o vínculo existir) — possa esperar sem segurar os outros.
//
// O ARRANJO (mocks e bancos de mentira) é o mesmo nos dois arquivos, de
// propósito: duplicá-lo UMA vez custa menos que quatro, e um arranjo por PR
// evita que um vermelho de um segure o outro.
